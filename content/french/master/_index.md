...
programme_m1:
  ...
  - semestre: "Semestres 1 & 2 — Enseignements thématiques et d'ouverture"
    ...
    cours:
      ...
      - name: "Bloc d'ouverture — (1 type de config au choix)"
        langue: ""
        heures: ""
        ects: "2"
        items:
          - "1 PSL week (2 ECTS)"
          - "ou 1 semestre langue (1 ECTS) + UE sport (1 ECTS)"
          - "ou 2 semestres langue (ou sport, 2 ECTS)"
          - "ou engagement étudiant (2 ECTS)"
          - "ou 1 autre enseignement thématique"
